		...
		battle.getBattle(characterData.battle_id, function(err, battleData) {
			...
			case 'attack':
				items.getUserItem(mid, function(err, userItemData) {
					...
					attack(uid, events, userItemData, battleData, characterData, monsterData, callback);
				});
				break;
			case 'item':
				items.getUserItem(mid, function(err, userItemData) {
			...
			case 'defend':
				...
				break;
			case 'flee':
				flee(uid, events, battleData, characterData, monsterData, callback);
				break;
			}
		});
	});
...
function attack(uid, events, userItemData, battleData, characterData, monsterData, callback) {
