...
function rewardExp(uid, characterData, monster, callback) {
	var max_exp = config.get('battle_base_exp_max'),
		min_exp = config.get('battle_base_exp_min');
...
function rewardPoints(uid, characterData, monster, callback) {
	var max_reward = config.get('battle_base_reward_max'),
		min_reward = config.get('battle_base_reward_min');
